...
//					.executeQuery("SELECT city, zip, county FROM cities_extended WHERE state_code='" + state + "' order by zip");
			ResultSet result = statement.executeQuery("SELECT city, zip_code, county FROM zipcodes_bystate WHERE state='" + state + "' order by zip_code");
...
//			ArrayList<CityZipCounty> bucket11 = new ArrayList<CityZipCounty>();
//			ArrayList<CityZipCounty> bucket12 = new ArrayList<CityZipCounty>();
//			ArrayList<CityZipCounty> bucket13 = new ArrayList<CityZipCounty>();
//			ArrayList<CityZipCounty> bucket14 = new ArrayList<CityZipCounty>();
//			ArrayList<CityZipCounty> bucket15 = new ArrayList<CityZipCounty>();
//			ArrayList<CityZipCounty> bucket16 = new ArrayList<CityZipCounty>();
			int counter = 0;
...
//		String password = "password";
	...
	public static void tryExitDriver(WebDriver driver4) {
		if (driver4 != null) {
			driver4.close();
		}
	}
